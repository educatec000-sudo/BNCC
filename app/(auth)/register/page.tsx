...
export default function RegisterPage() {
  ...
  const handleGoogleSignIn = async () => {
    if (!googleAvailable) {
      setError("Cadastro com Google não configurado. Execute npm run check:env no servidor.")
      return
    }
    setError("")
  ...
  return (
    <AuthShell title="Comece com um planejamento que considera cada estudante.">
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader className="text-center">
          ...
          <CardDescription>2 planos de aula gratuitos no total, sem cartão de crédito</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          >
            ...
            {googleAvailable === false ? "Google não configurado" : "Cadastrar com Google"}
          </Button>
