...
export function PrintDocumentActions({ planId }: { planId: string }) {
  ...
  return (
    <div className="print-hidden sticky top-0 z-50 flex flex-wrap items-center justify-center gap-3 border-b bg-background/95 p-3 shadow-sm backdrop-blur" data-print-hidden="true">
